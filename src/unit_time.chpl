module Unit_time {
    ...
    proc time(unitObj: shared AbstractUnitObj, constant: real, value: real): unit {
        return new unit(0, 0, 1, 0, 0, 0, 0, unitObj.getCoefficient(), constant, value, unitObj.getSymbol());
    }
